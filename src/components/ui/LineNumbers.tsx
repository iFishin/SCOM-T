...
export const LineNumbers = forwardRef<HTMLDivElement, LineNumbersProps>(
  function LineNumbers({ text, className = "", activeLine }: LineNumbersProps, ref) {
    ...
    return (
      <div
        ref={ref}
        className={`pointer-events-none select-none overflow-hidden border-r border-[var(--border)] bg-[var(--bg-input)] py-2 text-right font-mono text-theme-12 leading-[20px] text-[var(--text-muted)] ${className}`}
        style={{
